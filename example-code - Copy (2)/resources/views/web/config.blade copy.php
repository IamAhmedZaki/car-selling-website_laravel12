...
<head>
    ...
    <style>
        ...
        .flag_canvas_container {
            ...
            overflow: hidden;
            margin-bottom: 10px;
            clip-path: polygon(2.20% 0%, 30% 8%, 30% 99%, 3% 92%);
        }

        /* .flag_canvas_container .canvas_flagLeft {
            background-color: #000000 !important;
        }

        .flag_canvas_container .canvas_flagRight {
            background-color: #df097b !important;
        } */
...
<body>
    ...
    <div class="mainParentConfig">
        ...
        <div class="configBox">
            ...
            <map name="image-map">
                ...
                <area target="" alt="Right Black Area" title="Right Black Area" coords="330,49,360,275"
                ...
                <area target="" alt="Bottom Black Area" title="Bottom Black Area" coords="43,357,369,389"
            ...
            <div class="tabContent" id="Wall">
                <div class="col-6"
                    style="display: flex; justify-content: space-between; align-items: center; gap: 200px;">
                    <div class="wallsContentBox mt-5">
                        <div class="wallsContentBoxes">
                            <div class="switch-container">
                                <label class="switch">
                                    <input type="checkbox" id="leftwall_switch" class="switch"
                                        data-key="leftWallSwitch" onclick="switchActiveCanvas('leftWallSwitch')">
                            ...
                            <div>
                                ...
                                <div>
                                    <img src="{{ asset('web/img/1.png') }}" alt="" class="numImg"
                                        id="leftWallImage">
                        ...
                        <div class="wallsContentBoxes">
                            <div class="switch-container">
                                <label class="switch">
                                    <input type="checkbox" id="rightwall_switch" class="switch"
                                        data-key="rightWallSwitch" onclick="switchActiveCanvas('rightWallSwitch')">
                                    <span class="slider"></span>
                                </label>
                            ...
                            <div>
                                ...
                                <div>
                                    <img src="{{ asset('web/img/2.png') }}" alt="" class="numImg"
                                        id="rightWallImage">
                                    <div class="d-flex  py-3">
                                        <div class="position-absolute form-check d-flex " style="right: 415px;">
                        ...
                        <div class="wallsContentBoxes">
                            <div class="switch-container">
                                <label class="switch">
                                    <input type="checkbox" id="backwall_switch" class="switch"
                                        data-key="backWallSwitch" onclick="switchActiveCanvas('backWallSwitch')">
                                    <span class="slider"></span>
                                </label>
                            ...
                            <div class="position-relative">
                                <img src="{{ asset('web/img/1.png') }}" alt="" class="numImg"
                                    id="backWallImage">
                                <div class="d-flex py-3">
                                    <div class="position-absolute mx-auto form-check d-flex" style="left: 65px;">
                    ...
                    <div id="wall_canvas_container" style="position: relative; top: 100px;">
                        <div id="wall_canvas_container_canvasLeftWall" class="wall_canvas_container canvasLeftWall">
                            <canvas id="canvasLeftWall" width="300" height="300"></canvas>
                        </div>
                        <div id="wall_canvas_container_canvasRightwall" class="wall_canvas_container canvasRightwall">
                            <canvas id="canvasRightWall" width="300" height="300"></canvas>
                        </div>
                        <div id="wall_canvas_container_canvasBackWall" class="wall_canvas_container canvasBackWall">
    ...
    <script>
        ...
        $("#wall_canvas_container_canvasLeftWall").hide();
        $("#wall_canvas_container_canvasRightwall").hide();
        $("#wall_canvas_container_canvasBackWall").hide();
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.switchActiveCanvas = function(areaId) {
                ...
                // document.querySelectorAll('.canvas-container, .canvas-container-black').forEach(
                //     container => {
                ...
                switch (areaId) {
                    ...
                    case 'leftWallSwitch':
                        ...
                        //Wall
                        $("#wall_canvas_container_canvasLeftWall").show();
                        $("#wall_canvas_container_canvasRightwall").hide();
                        $("#wall_canvas_container_canvasBackWall").hide();
                    ...
                    case 'rightWallSwitch':
                        ...
                        //Wall
                        $("#wall_canvas_container_canvasLeftWall").hide();
                        $("#wall_canvas_container_canvasRightwall").show();
                        $("#wall_canvas_container_canvasBackWall").hide();
                    ...
                    case 'backWallSwitch':
                        ...
                        $("#wall_canvas_container_canvasLeftWall").hide();
                        $("#wall_canvas_container_canvasRightwall").hide();
                        $("#wall_canvas_container_canvasBackWall").show();
            ...
            //             } else {
            //                 console.error(
            //                     'No active canvas found to add image'); // Debugging line
            //             }
            //         };
            //     };
