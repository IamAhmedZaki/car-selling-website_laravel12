    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.switchActiveCanvas = function(areaId) {
                ...
                switch (areaId) {
                    case 'top':
                        newActiveCanvas = canvasTop;
                        break;
                    case 'right':
                        newActiveCanvas = canvasRight;
                        break;
                    case 'bottom':
                        newActiveCanvas = canvasBottom;
                        break;
                    case 'left':
                        newActiveCanvas = canvasLeft;
                        break;
                    case 'topBlack':
                        newActiveCanvas = canvasTopBlack;
                        break;
                    case 'rightBlack':
                        newActiveCanvas = canvasRightBlack;
                        break;
                    case 'bottomBlack':
                        newActiveCanvas = canvasBottomBlack;
                        break;
                    case 'leftBlack':
                        newActiveCanvas = canvasLeftBlack;
                        break;
                    case 'leftWallSwitch':
                        newActiveCanvas = canvasLeftWall;
                        break;
                    case 'rightWallSwitch':
                        newActiveCanvas = canvasRightWall;
                        break;
                    case 'backWallSwitch':
                        newActiveCanvas = canvasBackWall;
                        break;
                    case 'tableTop':
                        newActiveCanvas = tableTop;
                        break;
                    case 'tableRight':
                        newActiveCanvas = tableRight;
                        break;
                    case 'tableBottom':
                        newActiveCanvas = tableBottom;
                        break;
                    case 'tableLeft':
                        newActiveCanvas = tableLeft;
                        break;
                    case 'tableCenter':
                        newActiveCanvas = tableCenter;
                        break;
                    case 'flagLeft':
                        newActiveCanvas = flagLeft;
                        break;
                    case 'flagRight':
                        newActiveCanvas = flagRight;
                        break;
                    default:
                ...
                // Check if the selected canvas is already active
                if (newActiveCanvas === activeCanvas) {
                    console.log('Selected canvas is already active.');
                    return; // Exit the function early to avoid re-selecting the same canvas
                }

                // Update the active canvas and rebind events
            ...
            // Set up click event listeners on all canvases
            [canvasTop, canvasRight, canvasBottom, canvasLeft, canvasTopBlack, canvasRightBlack, canvasBottomBlack,
                canvasLeftBlack, canvasLeftWall, canvasRightWall, canvasBackWall, tableTop, tableRight, tableBottom,
                tableLeft, tableCenter, flagLeft, flagRight
            ].forEach(canvas => {
                canvas.getElement().addEventListener('click', function() {
                    window.switchActiveCanvas(canvas.getElement().id);
                });
            });
            ...
            // Bind updateProperties to the active canvas
            activeCanvas.on('selection:created', updateProperties);
            activeCanvas.on('selection:updated', updateProperties);

            // Functionality for updating text properties remains the same
            ...
            // Function to load canvas data from the database
            function loadCanvasData(canvasData) {
                canvasData.forEach(function(canvasDatum) {
                    const {
                        canvasId,
                        base64Data
                    } = canvasDatum;
            ...
            function getCanvasById(canvasId) {
                switch (canvasId) {
                    ...
                    case 'canvasLeft':
                        return canvasLeft;
                    case 'canvasTopBlack':
                        return canvasTopBlack;
                    case 'canvasRightBlack':
                        return canvasRightBlack;
                    case 'canvasBottomBlack':
                        return canvasBottomBlack;
                    case 'canvasLeftBlack':
                        return canvasLeftBlack;
                    case 'canvasLeftWall':
                        return canvasLeftWall;
                    case 'canvasRightWall':
                        return canvasRightWall;
                    case 'canvasBackWall':
                        return canvasBackWall;
                    case 'tableTop':
                        return tableTop;
                    case 'tableRight':
                        return tableRight;
