...
<body>
                ...
                <div class="rows" style="display: flex; margin-top:50px;">
                    ...
                    <div class="col-6" style="text-align: -webkit-center;">
                        <div id="canvas-container">
                            ...
                            {{-- Size 3x4 --}}
                            <div id="canvas_container_canvasTop34" class="canvas-container canvasTop34"
                                style="background-color: {{ $color1 }}; width: 400px; height: 250px;">
                                <canvas id="canvasTop34" width="400" height="250"></canvas>
                            </div>
                            <div id="canvas_container_canvasBottom34" class="canvas-container canvasBottom34"
                                style="background-color: {{ $color1 }}; width: 400px; height: 250px;">
                                <canvas id="canvasBottom34" width="400" height="250"></canvas>
                            </div>

                            {{-- Size 3x6 --}}
                            <div id="canvas_container_canvasTop36" class="canvas-container canvasTop36"
                                style="background-color: {{ $color1 }}; width: 400px; height: 250px;">
                                <canvas id="canvasTop36" width="400" height="250"></canvas>
                            </div>
                            <div id="canvas_container_canvasBottom36" class="canvas-container canvasBottom36 "
                                style="background-color: {{ $color1 }}; width: 400px; height: 250px;">
                                <canvas id="canvasBottom36" width="400" height="250"></canvas>
                            </div>
    ...
    <script>
        ...
        $("#canvas_container_canvasTop, #canvas_container_canvasLeft, #canvas_container_canvasRight, #black_canvas_container_canvasTopBlack, #black_canvas_container_canvasRightBlack, #black_canvas_container_canvasBottomBlack, #black_canvas_container_canvasLeftBlack, #table_canvas_container_tableTop, #table_canvas_container_tableRight, #table_canvas_container_tableBottom, #table_canvas_container_tableLeft, #table_canvas_container_tableCenter, #flag_canvas_container_flagLeft, #flag_canvas_container_flagRight, #leftwall_data, #rightwall_data, #backwall_data,#canvas_container_canvasTop34,#canvas_container_canvasTop36")
            .hide();
            ...
            window.switchActiveCanvas = function(areaId) {
                ...
                switch (areaId) {
                    ...
                    case 'bottom':
                        ...
                        if (size == "3x3") {
                            $("#canvas_container_canvasBottom").show();
                            $("#canvas_container_canvasBottom34").hide();
                            $("#canvas_container_canvasBottom36").hide();
                            activeCanvas = canvasBottom;
                        } else if (size == "3x4") {
                            $("#canvas_container_canvasBottom").hide();
                            $("#canvas_container_canvasBottom34").show();
                            $("#canvas_container_canvasBottom36").hide();
                            activeCanvas = canvasBottom34;
                        } else if (size == "3x6") {
                            $("#canvas_container_canvasBottom").hide();
                            $("#canvas_container_canvasBottom34").hide();
                            $("#canvas_container_canvasBottom36").show();
                            activeCanvas = canvasBottom36;
                        }
