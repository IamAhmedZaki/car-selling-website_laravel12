        ...
        <div class="configBox">
            ...
            <div class="tabContent" id="Roof" style="display: block;">
                <div class="rows" style="display: flex; margin-top:50px;">
                    ...
                    <div class="col-6 position-relative" style="text-align: -webkit-center;">
                        ...
                        <div class="blackCanvasContainOuter">
                            <div id="black_canvas_container">
                                <div class="blackCanvasTopBotomImgs">
                                    <div id="black_canvas_container_canvasTopBlack"
                                        class="black_canvas_container canvasTopBlack" onclick="switchActiveCanvas('canvasTopBlack')"
                                        style="background-color: {{ $color2 }}; width: 280px; height: 40px;">
                                        <canvas id="canvasTopBlack" height="40" width="280"></canvas>
                                    </div>
                                    <div id="black_canvas_container_canvasBottomBlack"
                                        class="black_canvas_container canvasBottomBlack" onclick="switchActiveCanvas('canvasBottomBlack')"
                                ...
                                <div class="blackCanvasLeftRightImgs">
                                    <div id="black_canvas_container_canvasLeftBlack"
                                        class="black_canvas_container canvasLeftBlack" onclick="switchActiveCanvas('canvasLeftBlack')"
                                        style="background-color: {{ $color2 }}; width: 70px; height: 300px;">
                                        <canvas id="canvasLeftBlack" width="70" height="300"></canvas>
                                    </div>
                                    <div id="black_canvas_container_canvasRightBlack"
                                        class="black_canvas_container canvasRightBlack" onclick="switchActiveCanvas('canvasRightBlack')"
                                        style="background-color: {{ $color2 }}; width: 70px; height: 300px;">
                        ...
                        <div id="leftwall_data">
                            ...
                            <div>
                                <div id="wall_canvas_container_canvasLeftWall"
                                    ...
                                    onclick="switchActiveCanvas('canvasLeftWall')">
                        ...
                        <div id="rightwall_data">
                            ...
                            <div>
                                <div id="wall_canvas_container_canvasRightwall"
                                    ...
                                    onclick="switchActiveCanvas('canvasRightWall')">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const canvases = {
                ...
                canvasLeftWall: new fabric.Canvas('canvasLeftWall'),
                canvasRightWall: new fabric.Canvas('canvasRightWall'),
